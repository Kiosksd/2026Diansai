...
static  UART_Regs                   *uart_list[UART_NUM]                = {UART0, UART1, UART3, UART4, UART5, UART6, UART7};
static  IRQn_Type                   uart_irq[UART_NUM]                  = {UART0_INT_IRQn, UART1_INT_IRQn, UART3_INT_IRQn, UART4_INT_IRQn, UART5_INT_IRQn, UART6_INT_IRQn, UART7_INT_IRQn};
static  uint8                       uart_interrupt_state[UART_NUM]      = {0, 0, 0, 0, 0, 0, 0};

static  void uart_callbakc_defalut (uint32 event, void *ptr);
        void                        *uart_callback_ptr_list[UART_NUM]   = {NULL, NULL, NULL, NULL, NULL, NULL, NULL};
        void_callback_uint32_ptr    uart_callback_list[UART_NUM]        = {uart_callbakc_defalut, uart_callbakc_defalut, uart_callbakc_defalut, uart_callbakc_defalut, uart_callbakc_defalut, uart_callbakc_defalut, uart_callbakc_defalut};
